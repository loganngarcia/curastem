...
1. **Validate** — Acknowledge their stress and normalize it
2. **Plan** — Use whiteboard to map options or break down an overwhelming task
3. **Document** — Use doc editor to create a personalized stress-management plan
4. **Resources** — Consider retrieve_resources for campus wellness or counseling if relevant
