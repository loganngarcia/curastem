...
1. **Clarify** — Understand their situation: prospective borrower, current borrower, or repayment
2. **Explain** — Use doc editor to create comparison tables and plan summaries
3. **Visualize** — Use whiteboard for timelines and decision flowcharts
4. **Resources** — Call retrieve_resources for official links and calculators
