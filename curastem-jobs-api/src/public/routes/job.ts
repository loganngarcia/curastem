...
import { getJobById, resolveJobLocationPoints, updateJobAiFields, updateCompanyEnrichment, updateJobDescriptionRaw, getSourceById, type FullJobRow } from "../../shared/db/queries.ts";
import { buildPublicSalary, extractJobFields } from "../../shared/enrichment/ai.ts";
import { extractKeywords } from "../../shared/enrichment/keywords.ts";
import { fetchSmartRecruitersDescription } from "../../shared/ingestion/sources/smartrecruiters.ts";
import type { Env, JobDescriptionExtracted, PublicJob } from "../../shared/types.ts";
...
import { seniorityFromExperienceYears } from "../../shared/utils/normalize.ts";
    ...
    try {
      ...
      if (salaryPayload) {
        if (row.salary_min === null) {
          ...
          row.salary_period = salaryPayload.period as import("../../shared/types.ts").SalaryPeriod;
        }
